  ...
  <div id="rev_slider" class="rev_slider"  data-version="5.0">
    ...
    <!-- SLIDE  -->
      <li data-transition="fade">
        <!-- MAIN IMAGE -->
        <img src="<?= base_url(); ?>assets/images/banner1.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgparallax="10" class="rev-slidebg">
        <!-- LAYER NR. 1 -->
        ...
        data-start="800"><h1>SMK Negeri 1 Batu</h1>
        </div>
        <div class="tp-caption tp-resizeme"
        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
      ...
      <li data-transition="fade">
        <img src="<?= base_url(); ?>assets/images/banner2.jpg"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgparallax="10" class="rev-slidebg">
        <div class="tp-caption tp-resizeme"
        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
        data-y="['326','270','270','150']" data-voffset="['0','0','0','0']"
        data-responsive_offset="on"
  ...
  <div class="container margin_top">
    <div class="row">
      <div class="col-md-7 col-sm-6 priorty wow fadeInLeft" data-wow-delay="300ms">
        <h2 class="heading bottom25">Selamat Datang di SMKN 1 BATU <span class="divider-left"></span></h2>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <a href="#." class="border_radius"><img src="<?= base_url(); ?>assets/images/hands.png" alt="hands"></a>
            <h4>Good Planning</h4>
            <p>Renean sit amet massa</p>
            </div>
            <div class="about-post">
            <a href="#." class="border_radius"><img src="<?= base_url(); ?>assets/images/awesome.png" alt="hands"></a>
          ...
          <div class="col-md-6">
            <div class="about-post">
            <a href="#." class="border_radius"><img src="<?= base_url(); ?>assets/images/maintenance.png" alt="hands"></a>
            <h4>Our Courses</h4>
            <p>Renean sit amet massa</p>
            </div>
            <div class="about-post">
            <a href="#." class="border_radius"><img src="<?= base_url(); ?>assets/images/home.png" alt="hands"></a>
            <h4>Our Teachers</h4>
            <p>Renean sit amet massa</p>
            </div>
          </div>
      ...
      <div class="col-md-5 col-sm-6 wow fadeInRight" data-wow-delay="300ms">
         <img src="<?= base_url(); ?>assets/images/about.jpg" alt="our priorties" class="img-responsive" style="width:100%;">
      </div>
    </div>
  </div>
</section>
...
<section id="courses" class="padding parallax">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="heading heading_space wow fadeInDown">Paket Keahlian<span class="divider-left"></span></h2>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
          ...
          <div id="course_slider" class="owl-carousel">
            <div class="item">
              <div class="image bottom20">
                <img src="<?= base_url(); ?>assets/images/course1.jpg" alt="Courses" class="img-responsive border_radius">
              </div>
              <h3 class="bottom15"><a href="course_detail.html">Akomodasi Perhotelan</a></h3>
            ...
            <div class="item">
              <div class="image bottom20">
                <img src="<?= base_url(); ?>assets/images/course2.jpg" alt="Courses" class="img-responsive border_radius">
              </div>
              <h3 class="bottom15"><a href="course_detail.html">Jasa Boga</a></h3>
              <p class="bottom15">We offer the most complete house renovating services in the country, from kitchen design to bathroom remodeling.</p>
              <a href="course_detail.html" class="btn_common blue border_radius">Read More</a>
            </div>
            <div class="item">
              <div class="image bottom20">
                <img src="<?= base_url(); ?>assets/images/course3.jpg" alt="Courses" class="img-responsive border_radius">
              </div>
              <h3 class="bottom15"><a href="course_detail.html">Tata Kecantikan Kulit dan Rambut</a></h3>
              <p class="bottom15">We offer the most complete house renovating services in the country, from kitchen design to bathroom remodeling.</p>
              <a href="course_detail.html" class="btn_common blue border_radius">Read More</a>
            </div>
            <div class="item">
              <div class="image bottom20">
                <img src="<?= base_url(); ?>assets/images/course4.jpg" alt="Courses" class="img-responsive border_radius">
              </div>
              <h3 class="bottom15"><a href="course_detail.html">Tata Busana</a></h3>
              <p class="bottom15">We offer the most complete house renovating services in the country, from kitchen design to bathroom remodeling.</p>
              <a href="course_detail.html" class="btn_common blue border_radius">Read More</a>
            </div>
          </div>
  ...
  <div class="container">
    ...
    <div class="row number-counters">
      ...
      <div class="col-md-7 col-sm-4">
        ...
        <img src="<?= base_url(); ?>assets/images/fun-facts.png" alt=" some facts" class="img-responsive">
        </div>
      </div>
          ...
          <div id="news_slider" class="owl-carousel">
            <div class="item">
              <div class="content_wrap">
                <div class="image">
                  <img src="<?= base_url(); ?>assets/images/news1.jpg" alt="Edua" class="img-responsive border_radius">
                </div>
            ...
            <div class="item">
              <div class="content_wrap">
                <div class="image">
                  <img src="<?= base_url(); ?>assets/images/news2.jpg" alt="Edua" class="img-responsive border_radius">
                </div>
                <div class="news_box border_radius">
            ...
            <div class="item">
              <div class="content_wrap">
                <div class="image">
                  <img src="<?= base_url(); ?>assets/images/news3.jpg" alt="Edua" class="img-responsive border_radius">
                </div>
                <div class="news_box border_radius">
                  <h4><a href="blog_detail.html">4 Springtime Color Schemes to Try at Home</a></h4>
                  <ul class="commment">
